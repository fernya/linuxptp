...
struct config_item config_tab[] = {
	...
	PORT_ITEM_INT("ts2phc.extts_index", 0, 0, INT_MAX),
	...
	PORT_ITEM_INT("ts2phc.slave", 0, 0, 1),
	PORT_ITEM_INT("ts2phc.input_latency", 0, INT_MIN, INT_MAX),
	PORT_ITEM_INT("ts2phc.output_latency", 0, INT_MIN, INT_MAX),
	PORT_ITEM_INT("ts2phc.function_test_pin", -1, 0, INT_MAX),
